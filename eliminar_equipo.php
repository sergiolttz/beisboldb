...
<body>
  ...
  <body>
    <section class="tarjeta-container">
      <div class="tarjeta">
        ...
        <form method="post" action="">
          ...
          <div>
            <label><?php echo $row['nombre_equipo'] ?></label>
            <div class="button-container">
              <div class="elemento-izquierda elemento-izquierda-texto">
                <img src="img/eliminar_equipo.jpg" width="40" height="40">
                <button type="submit" name="eliminar">Eliminar equipo</button>
              </div>
              <div class="elemento-izquierda elemento-izquierda-texto">
    ...
    if (isset($_POST['eliminar'])) {
      $deleteequipo = isset($_POST['delete_equipo']) ? $_POST['delete_equipo'] : false;
      $sql = "DELETE FROM t_equipos WHERE id_equipo = $id";
