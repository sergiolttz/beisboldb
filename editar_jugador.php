...
<body>
  ...
  <div class="container">
      ...
      <div class="tarjeta">
        <form method="post" action="">
          ...
          <div>
            ...
            <input type="date" name="fecha_nacimiento_jugador" value="<?php echo $row['fecha_nacimiento_jugador'] ?>">
          </div>
          <div>
            <h3>Lugar de Nacimiento</h3>
            <input type="text" name="lugar_nacimiento_jugador" value="<?php echo $row['lugar_nacimiento_jugador'] ?>">
          </div>
          <div>
            <h3>Nacionalidad</h3>
          ...
          <div>
            <h3>Altura (cm)</h3>
            <input type="number" name="altura" value="<?php echo $row['altura'] ?>">
          </div>
          <div>
            <h3>Peso (kg)</h3>
            <input type="number" name="peso" value="<?php echo $row['peso'] ?>">
          </div>
          <div>
          ...
          <div>
            ...
            <select name="brazo_lanzamiento" value="<?php echo $row['brazo_lanzamiento'] ?>">
              <option value="D">(D) Derecho</option>
              <option value="I">(I) Izquierdo</option>
              <option value="A">(A) Ambidiestro</option>
            </select>
          ...
          <div class="button-container">
            ...
            <div class="elemento-izquierda elemento-izquierda-texto">
              ...
              <a href="equipo.php?id=<?php echo $pagina_anterior; ?>"><button type="button">Volver</button></a>
            </div>
          </div>
        </form>
      </div>
    ...
    if (isset($_POST['guardar'])) {
      ...
      $lugar_nacimiento = $_POST['lugar_nacimiento_jugador'];
      ...
      $sql_guardar = "UPDATE t_jugadores SET
                  nombre_jugador = '$nombre',
                  id_equipo = '$id_equipo',
                  numero = '$numero',
                  fecha_nacimiento_jugador = '$fecha_nacimiento',
                  lugar_nacimiento_jugador = '$fecha_nacimiento';
                  nacionalidad_jugador = '$nacionalidad',
                  posicion = '$posicion',
                  altura = '$altura',
                  peso = '$peso',
                  brazo_bateo = '$brazo_bateo',
                  brazo_lanzamiento = '$brazo_lanzamiento'
                  WHERE id_jugador = $id";
